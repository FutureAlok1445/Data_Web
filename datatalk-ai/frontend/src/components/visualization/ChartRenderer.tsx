...
export const ChartRenderer: React.FC<ChartRendererProps> = ({ data, query, suggestedChart }: ChartRendererProps) => {
    ...
    const chartType = useMemo(() => {
        return decideChartType(data, xCol, yCol, query, secondDimCol, suggestedChart);
    }, [data, xCol, yCol, query, secondDimCol, suggestedChart]);
